...
// ThreadedCommand testCommand1 = new ThreadedCommand(dummyCommand,
// dummyPeriodValue1);
// assert(testCommand1.getPeriod() == dummyPeriodValue1);

// ThreadedCommand testCommand2 = new ThreadedCommand(dummyCommand,
// dummyPeriodValue2);
// assert(testCommand2.getPeriod() == dummyPeriodValue2);

// ThreadedCommand testCommand3 = new ThreadedCommand(dummyCommand,
// dummyPeriodValue3);
// assert(testCommand3.getPeriod() == dummyPeriodValue3);

// ThreadedCommand testCommand4 = new ThreadedCommand(dummyCommand,
// dummyPeriodValue4);
